                      ...
                      <div class="col-lg-6">
                        <div class="card-body p-md-5 mx-md-4">
                          ...
                          <div class="text-center">
                            ...
                            <h4 class="mt-1 mb-5 pb-1">¡Cafeteria Stephanies!</h4>
                          </div>
                          ...
                          <form action="{{ route('register') }}" method="post">
                            ...
                            <div class="text-center pt-1 mb-5 pb-1">
                              <a href="/menuadmin" class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="button">Registrarse</a>
                            </div>
