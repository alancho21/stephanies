                  ...
                  <div class="card rounded-3 text-black">
                    <div class="row g-0">
                      <div class="col-lg-6">
                        <div class="card-body p-md-5 mx-md-4">
                            ...
                            <div class="text-center">
                                <img src="{{ asset('cssStyles/Caf2.png') }}" style="width: 185px;" alt="logo">
                      ...
                      <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                            <img src="cssStyles/Caf3.png" alt="Caf3" class="img-fluid w-100" style="max-width: 600px; height: auto;">
                        </div>
                      </div>
                    </div>
                  </div>
